...
# All approved clauses included
    ...
    allowed_grouptravelminimumpassengers := ["3"]
    allowed_grouptravelrecommendeddistance := ["200"]
    ...
    allowed_grouptravelminimumpassengers[_] == input.grouptravelminimumpassengers
    allowed_grouptravelrecommendeddistance[_] == input.grouptravelrecommendeddistance
    }
    ...
    # Action: enforce
    # Ambiguous: False
    allow_c12_gen := {"allow": true, "reason": "Clause C12: INFORMATIONAL - EDITED"} if {
    ...
    allowed_reimbursementcondition := ["The lesser of the eligible amount or the bill amount"]
